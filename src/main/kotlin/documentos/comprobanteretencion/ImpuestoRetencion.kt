...
import utils.expresionRegularPorcentaje
...
class ImpuestoRetencion : ImpuestoBase {
    ...
    @Pattern(
        regexp = "9|10|1|11|2|3|7|8|4580|303|304|304A|304B|304C|304D|304E|307|308|309|310|311|" +
                ...
                "518|519|520|520A|520B|520D|520E|520F|520G|521|522A|523A|525|525|(\\w|[0-9]){1,8}",
    ...
    @Pattern(
        regexp = expresionRegularPorcentaje,
    ...
    @Pattern(
        regexp = "^([0-9]{15,16})\$",
        message = "numDocSustento $mensajeValores de 15 - 16 digitos"
    )
